...
export const fetchOrdersThunk = createAsyncThunk('order/fetchAll', async (_, thunkAPI) => {
  try {
...
export const fetchOrderByIdThunk = createAsyncThunk('order/fetchById', async (id, thunkAPI) => {
  try {
...
export const updateOrderStatusThunk = createAsyncThunk('order/updateStatus', async ({ id, status }, thunkAPI) => {
  try {
